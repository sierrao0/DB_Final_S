...
public class BibliotecaDTO {
    ...
    public BibliotecaDTO(Long id, String nombre, String direccion, String ciudad){
        super();
        this.id = id;
        this.nombre = nombre;
    ...
    public static JSONArray toJSONArray( Iterable<BibliotecaDTO> bibliotecas) throws Exception {
        JSONArray jbibliotecas = new JSONArray();
        Iterator<BibliotecaDTO> ibibliotecas = bibliotecas.iterator();
        while(ibibliotecas.hasNext()) {
            BibliotecaDTO biblioteca = ibibliotecas.next();
